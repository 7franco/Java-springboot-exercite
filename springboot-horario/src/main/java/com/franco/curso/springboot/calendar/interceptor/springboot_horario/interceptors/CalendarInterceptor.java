package com.franco.curso.springboot.calendar.interceptor.springboot_horario.interceptors;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            throws Exception {
                ...
                if(hour >= open && hour < close){
                    StringBuilder message = new StringBuilder("Bienvenidos al horario de ateción al clientes");
